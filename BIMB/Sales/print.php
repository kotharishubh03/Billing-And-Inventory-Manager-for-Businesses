    ...
    <table class="sk-table w3-table">
        ...
        <tr>
            <td colspan="5" rowspan="2" class="w3-small" style="width:50%">
                <b class="w3-medium">SARVODAYA ELECTRIC AND HARDWARE CENTRE</b><br>
                <br>
                S/5, Motimahal C.H.S Ltd. , G.Gupte Road ,
                Opp. Telephone Exchange , Dombivili (W)-421202.<br>
                <br>
                GSTIN:- <b>27AATPJ1430G1ZR</b><br>
                TELE:- <b>98202258975/9969449935</b><br>
                Email:- <b>sehc1976@gmail.com</b>
            </td>
        ...
        <tr>
            <td colspan="6" class="w3-small sk-no-border" style="width:60%">
                ...
                1)subject to kalyan jurisdiction<br>
                2)cheque bounce charges Rs.500/only.<br>
                3)Transport & other charges extra as applicable.<br>

            </td>
            <td colspan="4" class=" w3-display-container sk-no-border w3-small" style="width:40%">
                <div class="w3-display-topright">
                    <b>For SARVODAYA ELECTRIC AND HARDWARE CENTRE</b><br><br>
                </div>
